...
export default function AuthProviderFencer({ children }) {
    ...
    useEffect(() => {
        const verifyToken = async () => {
            ...
            if (!sessionStorage.getItem('refreshToken') || sessionStorage.getItem("userType") !== "F") {
            ...
            try {
                ...
                console.error("Token verification failed in AuthProviderFencer");
                navigate('/signin');
            } finally {
                setLoading(false);
            }
